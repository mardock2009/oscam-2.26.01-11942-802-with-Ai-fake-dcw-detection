...
Configuring custom ticket fields in the [\[ticket-custom\]](https://trac.streamboard.tv/oscam/wiki/TracIni#ticket-custom-section) section of trac.ini.
...
+   **text**: A simple (one line) text field.
    ...
    +   max\_size: Maximum allowed size in characters (*Since 1.3.2*).
    +   format: One of:
        +   `plain` for plain text
        +   `wiki` for [wiki formatted](https://trac.streamboard.tv/oscam/wiki/WikiFormatting) content
...
+   **textarea**: Multi-line text area.
    ...
    +   order: Sort order placement.
    +   max\_size: Maximum allowed size in characters (*Since 1.3.2*).
    +   format: Either `plain` for plain text or `wiki` to interpret the content as [WikiFormatting](https://trac.streamboard.tv/oscam/wiki/WikiFormatting).
...
See also: [TracTickets](https://trac.streamboard.tv/oscam/wiki/TracTickets), [TracIni](https://trac.streamboard.tv/oscam/wiki/TracIni)

[Last modified](https://trac.streamboard.tv/oscam/wiki/TracTicketsCustomFields?action=diff&version=6 "Version 6 by trac") [2 years ago](https://trac.streamboard.tv/oscam/timeline?from=2020-06-07T14%3A06%3A46%2B02%3A00&precision=second "See timeline at 06/07/20 14:06:46") Last modified on 06/07/20 14:06:46
