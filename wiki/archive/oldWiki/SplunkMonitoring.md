...
#### Installing Splunk
To download **Splunk**, you need an account at www.splunk.com
It free, so just create one.

Go to:**Products** -> **Overview** -> **Splunk® Enterprise** -> **Free download**
Select your OS -> **Windows, Linux, Solaris, Mac OS**
...
### Firewall
Now Splunk is ready to collect data. But first you need to open your firewall, to get **UDP:514** to pass trough.
If your OSCam is on another site, you need to add port forwarding in your internet router as well.
...
[[http://www.streamboard.tv/wbb2/thread.php?threadid=44559|Streamboard Forum post]]